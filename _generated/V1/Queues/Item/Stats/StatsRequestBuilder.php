...
/**
 * Builds and executes requests for operations under /v1/queues/{name}/stats
*/
class StatsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/v1/queues/{name}/stats');
    ...
    /**
     * snapshot queue metrics. Returns {length, acked, pending}. All counts are for this org's queue only
