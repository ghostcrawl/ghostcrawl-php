...
namespace GhostCrawl\V1\Page\Upload;

use Exception;
use GhostCrawl\Models\ProblemDetails;
use GhostCrawl\Models\UploadBody;
...
class UploadRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/v1/page/upload');
     ...
     * @param UploadBody $body The request body
     ...
     * @throws Exception
    */
    public function post(UploadBody $body, ?UploadRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(UploadBody $body, ?UploadRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
