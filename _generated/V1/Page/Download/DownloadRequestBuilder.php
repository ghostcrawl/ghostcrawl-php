...
namespace GhostCrawl\V1\Page\Download;

use Exception;
use GhostCrawl\Models\DownloadBody;
...
class DownloadRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/v1/page/download');
     ...
     * @param DownloadBody $body The request body
     ...
     * @throws Exception
    */
    public function post(DownloadBody $body, ?DownloadRequestBuilderPostRequestConfiguration $requestConfiguration = null): Promise {
    ...
    */
    public function toPostRequestInformation(DownloadBody $body, ?DownloadRequestBuilderPostRequestConfiguration $requestConfiguration = null): RequestInformation {
