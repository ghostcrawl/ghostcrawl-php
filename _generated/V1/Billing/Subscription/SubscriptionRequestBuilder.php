...
namespace GhostCrawl\V1\Billing\Subscription;
...
/**
 * Builds and executes requests for operations under /v1/billing/subscription
*/
class SubscriptionRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/v1/billing/subscription');
