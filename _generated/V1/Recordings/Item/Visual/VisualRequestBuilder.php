...
class VisualRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * Get the HLS-style manifest pointer for a visual recording. Returns 200 {manifest_url, frame_count, status, engine} or 404 forcross-tenant/missing (byte-identical, /91 pattern).
