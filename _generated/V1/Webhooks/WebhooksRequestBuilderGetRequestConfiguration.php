...
class WebhooksRequestBuilderGetRequestConfiguration extends BaseRequestConfiguration 
{
    ...
    */
    public static function createQueryParameters(?string $created_at_from = null, ?string $created_at_to = null, ?string $cursor = null, ?int $limit = null, ?string $owner_id = null, ?string $tags = null): WebhooksRequestBuilderGetQueryParameters {
        return new WebhooksRequestBuilderGetQueryParameters($created_at_from, $created_at_to, $cursor, $limit, $owner_id, $tags);
    }
