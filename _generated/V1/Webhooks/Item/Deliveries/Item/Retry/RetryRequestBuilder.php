...
class RetryRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    ...
    /**
     * webhooks:write. No tier gate. Cross-tenant → 404. Re-enqueues the failed delivery with a fresh delivery_id; the originalevent_id is preserved so downstream consumers can detect the retry.
