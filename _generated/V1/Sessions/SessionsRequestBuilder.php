...
class SessionsRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function __construct($pathParametersOrRawUrl, RequestAdapter $requestAdapter) {
        parent::__construct($requestAdapter, [], '{+baseurl}/v1/sessions{?created_at_from*,created_at_to*,cursor*,limit*,owner_id*,tags*}');
    ...
    /**
     * cursor-paginated listing of active sessions. Requires scope session:read. Sessions created by scrape workers andvia the API are unified in the same listing, all sessions for yourorganisation are visible. Results are strictly; nocross-organisation sessions are returned.
