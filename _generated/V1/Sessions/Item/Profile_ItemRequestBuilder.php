...
use GhostCrawl\V1\Sessions\Item\BudgetStream\BudgetStreamRequestBuilder;
...
class Profile_ItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function budgetStream(): BudgetStreamRequestBuilder {
        return new BudgetStreamRequestBuilder($this->pathParameters, $this->requestAdapter);
    }
