...
/**
 * Response for POST /v1/webhooks/{id}/rotate-secret.`secret` is the new signing secret. The previous secret remains validfor a short grace period so in-flight deliveries can still be verified.`prev_secret_expires_at` is when the grace period ends.
*/
