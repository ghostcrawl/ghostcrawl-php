...
class HarBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new HarBody and sets the default values.
    */
     ...
     * @return HarBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): HarBody {
        return new HarBody();
    }
