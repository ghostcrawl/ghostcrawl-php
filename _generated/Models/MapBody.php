...
/**
 * Firecrawl-compatible /v1/map request body.camelCase field names per Firecrawl spec (noqa: N815 silences pydanticnaming convention warnings for intentional camelCase).
*/
