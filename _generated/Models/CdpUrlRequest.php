...
class CdpUrlRequest implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new CdpUrlRequest and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CdpUrlRequest {
        return new CdpUrlRequest();
    }
