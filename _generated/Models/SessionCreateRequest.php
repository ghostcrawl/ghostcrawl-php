...
class SessionCreateRequest implements AdditionalDataHolder, Parsable 
{
    ...
    */
    ...
    /**
     * @var SessionCreateRequest_profile|null $profile Named persistent profile (gologin parity). Rehydrates the saved identity bundle for this session, same deterministic fingerprint as /v1/scrape with profile=<name>.
    */
    ...
    */
    ...
    /**
     * Gets the profile property value. Named persistent profile (gologin parity). Rehydrates the saved identity bundle for this session, same deterministic fingerprint as /v1/scrape with profile=<name>.
    ...
    */
    ...
    /**
     * Sets the profile property value. Named persistent profile (gologin parity). Rehydrates the saved identity bundle for this session, same deterministic fingerprint as /v1/scrape with profile=<name>.
