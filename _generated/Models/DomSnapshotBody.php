...
class DomSnapshotBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * Instantiates a new DomSnapshotBody and sets the default values.
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): DomSnapshotBody {
        return new DomSnapshotBody();
    }
